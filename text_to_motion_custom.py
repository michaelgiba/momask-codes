...
if __name__ == '__main__':
    ...
    parser.parser.add_argument('--output_file', type=str, required=True, help='File to save the generated BVH')
    opt = parser.parse()
    ...
    for r in range(opt.repeat_times):
        ...
        for k, (caption, joint_data)  in enumerate(zip(captions, data)):
            ...
            _, ik_joint = converter.convert(joint, filename=opt.output_file, iterations=100)